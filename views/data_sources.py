"""Data Sources — the live dashboard.

Renders each of the nine FRED indicators as its own Observable Plot chart.
Run via the app router (``app.py``); page chrome (set_page_config, branding,
logo, navigation) is applied there.
"""
